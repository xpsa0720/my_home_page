  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Image.asset(
          "assets/images/screen_on_flutter/screen_on_flutter_4.png",
        ...
        Text('구조', style: Text_style.copyWith(fontSize: screenWidth * 0.025)),
        Image.asset(
          "assets/images/screen_on_flutter/screen_on_flutter_5.png",
        ...
        SizedBox(
          width: screenWidth * 0.6,
          child: Text(
            '해당 플러그인의 치명적인 단점은 각 엔진의 프로바이더를 공유하지 못합니다. 상태 관리에 불리하기 때문에 하나의 플러터 엔진으로 락 스크린을 띄우는 고도화 작업을 진행할 예정입니다.',
            style: Text_style.copyWith(fontSize: screenWidth * 0.020),
          ),
        ),
        SizedBox(height: screenWidth * 0.02),
        ...
        Image.asset(
          "assets/images/screen_on_flutter/screen_on_flutter_8.png",
          width: screenWidth * 0.7,
          fit: BoxFit.cover,
        ),
        SizedBox(height: screenWidth * 0.02),
